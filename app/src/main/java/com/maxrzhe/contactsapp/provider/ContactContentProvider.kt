package com.maxrzhe.contactsapp.provider
...
import com.maxrzhe.contactsapp.database.DatabaseHandler.Companion.KEY_ID
import com.maxrzhe.contactsapp.database.DatabaseHandler.Companion.TABLE_CONTACTS
...
class ContactContentProvider : ContentProvider() {
    ...
    companion object {
        private const val AUTHORITY =
            "com.maxrzhe.contactsapp.provider.ContactContentProvider"
