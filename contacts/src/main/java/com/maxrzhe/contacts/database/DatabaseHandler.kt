...
class DatabaseHandler private constructor(context: Context) : SQLiteOpenHelper(
    ...
    private fun getContentValue(contact: Contact): ContentValues {
        ...
        with(contact) {
            contentValues.apply {
                put(com.maxrzhe.contacts.database.DatabaseHandler.KEY_NAME, name)
                put(com.maxrzhe.contacts.database.DatabaseHandler.KEY_PHONE, phone)
                put(com.maxrzhe.contacts.database.DatabaseHandler.KEY_EMAIL, email)
                put(com.maxrzhe.contacts.database.DatabaseHandler.KEY_IMAGE, image)
            }
        }
